...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <div class="col-md-3 text-end">
                    <a href="/member/info?userID=${sessionScope.sessionMemberDto.userID}" class="btn btn-primary">
                            ${sessionScope.sessionMemberDto.userName}
                    </a>
                    <a href="/member/logout" class="btn btn-outline-primary me-2">LOGOUT
                    </a>
